;(function(){
        ...
        function Broadcast(element,arrImg,radius,suspend,width){
            if(this instanceof Broadcast) {
                ...
                return new Broadcast(element,arrImg,radius,suspend,width);
            }
        };
        ...
        Broadcast.prototype = {
            ...
            initImgStyle : function(imgArr){
                for(var i = 0; i < this.len ; i ++) {
                    imgArr[i].style = "position:absolute;top:0;left:0;right:0;bottom:0;margin: auto;width:" + this.width+"px;";
